		                          ...
		                          <td width="456"><table>
		                            ...
		                            <tr>
		                              ...
		                              <td width="310" height="26">
		                                <input type="text" name="kname" readonly korOnly value="${ board.kname }">
		                              </td>
		                            </tr>
		                            <tr>
		                              ...
		                              <td height="26">
		                              	<input type="text" name="ename" readonly engOnly value="${ board.ename }">
		                              </td>
		                            </tr>
		                            <tr>
		                              <td height="26" align="right">
		                              ...
		                              <td height="26">
		                              	<input type="text" name="cname" readonly value="${ board.cname }">
		                              </td>
		                            </tr>
		                            <tr>
		                              <td height="26" align="right">
		                              ...
		                              <td>
			                              ...
			                              maxlength="6" placeholder="ex)970308" readonly numberOnly value="${ board.inumber1 }">-
			                              <input type="text" name="inumber2" id="inum2" size="15" 
			                              maxlength="7" placeholder="뒷자리 입력해주세요" readonly numberOnly value="${ board.inumber2 }">
		                              </td>
		                            </tr>
		                          </table>
		                          </td>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1">
                          ...
                          <tr> 
                            ...
                            <td width="268">
                            	<a href="src/main/webapp/resources/scuploadFiles/${ fi.changeName }">${ fi.changeName }</a>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table>
                          <tr> 
                            ...
                            <td width="391">
	                            <input name="year"	type="text" size="3"maxlength="4" readonly numberOnly value="${ board.year }">년 
		                        <input name="month" type="text" size="3"maxlength="2" readonly numberOnly value="${ board.month }">월 
		                        <input name="day" 	type="text" size="3"maxlength="2" readonly numberOnly value="${ board.day }">일 ( 
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1">
                          ...
                          <tr> 
                            ...
                            <td width="392">
                            	<input name="annual" type="text" size="1"maxlength="2" readonly value="${ board.annual }"> 
                            </td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr> 
                    	<td bgcolor="#E4EBF1"><table>
	                          <tr> 
	                            ...
	                            <td width="392">
		                            <input name="address1" type="text" size="10" readonly numberOnly value="${ board.address1 }"> 
		                            <input name="address2" type="text" size="40" readonly korOnly value="${ board.address2 }" > 
	                            </td>
	                          </tr>
	                        </table>
                    	</td>
                   		...
                   		<td bgcolor="#E4EBF1">
	                    	<table >
		                        <tr> 
			                        ...
			                        <td width="392">
				                        <input name="phone1" type="text" size="2"maxlength="3" readonly numberOnly value="${ board.phone1 }" >
				                        - 
				                        <input name="phone2" type="text" size="3"maxlength="4" readonly numberOnly value="${ board.phone2 }">
				                        - 
				                        <input name="phone3" type="text" size="3"maxlength="4" readonly numberOnly value="${ board.phone3 }">
			                        </td>
		                        </tr>
	                        </table>
                    	</td>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table>
                          <tr> 
                            ...
                            <td width="392"><input name="mail" type="text" size="20" readonly value="${ board.mail }"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
                      <td bgcolor="#E4EBF1"><table>
                          <tr> 
                            ...
                            <td width="392"><input name="grade" maxlength="1"type="text" engOnly readonly size="20" value="${ board.grade }"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table >
                          <tr> 
                            ...
                            <td width="392"><input name="alcohol"maxlength="5" readonly type="text" size="20" value="${ board.alcohol }"> 
                            </td>
                          </tr>
                        </table>
                  </table></td>
