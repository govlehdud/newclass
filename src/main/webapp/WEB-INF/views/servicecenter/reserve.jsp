        ...
        <table>
        	<thead>
	              <tr> 
	              	...
	              	<td width="85" align="center">근무</td>
	              <tr> 
              </thead>
				<!-------------------------  리스트 ------------------------------>
			  <tbody id ="listArea">
				...
				<c:if test="${ empty reserveList }">
	                ...
	                <c:forEach var="sc" items="${ reserveList }">
	                    <tr> 
	                      	<td width="35" height="20" align="center">
	                     		<input type="checkbox" name="checkbox" class="checkbox" value="${sc.code }"/>
	                      	</td>
...
<script type="text/javascript">
		...
		function searchBoard(){
			...
			location.href="reservesearch.sc?searchCondition="+searchCondition+"&searchValue="+searchValue;
		}
</script>
</body>
</html>
